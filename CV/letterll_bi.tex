...
(alt.~E-Mail:				&amantini.andrea@gmail.com)\\[+15mm]
\end{tabular}
}%
%}%
...
\end{tabular}
\newpage
\begin{tabular}{r@{\extracolsep{2em}}p{75mm}}
\multicolumn{2}{l}{\large\bf Lehrtätigkeiten an der HUB}\\[+1mm]
\hline\\[+1mm]
WS 08/09	& Übungsleiter im Fach Algebra I -- Dozent: Dr. W.~Kleinert\\[+1mm]
SoSe 09		& Übungsleiter im Fach Gewöhnlichen Differentialgleichungen -- Dozent: Dr.~L.~Recke\\[+1mm]
WS 09/10	& Übungsleiter im Fach Algebra II (BMS Basic Course Commutative Algebra) -- Dozent: Dr. W.~Kleinert\\[+6mm]
...
Franz\"osisch & gute Kenntnisse, sehr gutes Verst\"andnis beim Lesen\\[+6mm]
\multicolumn{2}{l}{\large\bf Betriebssysteme, Programmiersprachen, IDEs}\\[+1mm]
\hline\\[+1mm]
Mac OS X				 	&gute Kenntnisse\\
Unix/Linux, Windows			&friedlicher Umgang\\[+1mm]
\LaTeX \,``Typesetting" 		&erweiterte Kenntnisse\\
{\sl HTML, CSS, MySQL}		&Grundkenntnisse\\
Python, (Objective-) %$C$,
$C^{++}$ 	&Grundkenntnisse\\
Idle, XCode				&Grundkenntnisse\\[+7mm]
