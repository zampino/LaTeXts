...
WS 09/10	& Übungsleiter im Fach Algebra II (BMS Basic Course Commutative Algebra) -- Dozent: Dr. W.~Kleinert\\[+10mm]
...
{\sl XHTML, Javascript, CSS,}		&Grundkenntnisse\\
{\sl PhP, MySQL}&								\\[+1mm]
Python, (Obj-) %$C$,
$C^{++}$ 	&Grundkenntnisse\\[+1mm]
Netbeans, XCode				&Grundkenntnisse\\[+10mm]
\multicolumn{2}{l}{\large\bf Laufende Web-Projekte}\\[+1mm]
\hline\\[+1mm]
Labirinto Theater &    Web-design und Pflege der Internetseite\\& \url{www.labirintotheater.com} \\[+7mm]
