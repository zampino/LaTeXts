...
%---------------------------------------------------------------------------
\begin{letter}{{\bf Brückenschläger GbR}\\
Schieritzstr. 41\\
10409 Berlin}
%---------------------------------------------------------------------------
\setkomavar{subject}{Rechnung Nr.: 2012-06}
%---------------------------------------------------------------------------
\opening{}
\begin{tabular}{ccc@{\extracolsep{5em}}c}%{p{4cm}p{4cm}p{6cm}@{\extracolsep{2em}}p{4cm}}
{\bf Leistung}&{\bf Zeitfrist}&{\bf Betrag}\\
\hline\\
Extra Dings Bungs & &\\
( dreieinhalb TK Beiträge $(149,63\cdot3) + (149,63/2)$)  & May 2012 & 523,70 EUR\\
\hline\\
\end{tabular}
\vfil
\begin{flushright}
