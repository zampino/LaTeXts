...
\setkomavar{frombank}{}
\setkomavar{location}{\small\raggedleft Iban DE55120300000016120834\\[+.5mm]Swift\\BYLADEM1001\\[+1mm]PIN\\67 839 615 201}
...
%---------------------------------------------------------------------------
\setkomavar{subject}{Receipt Nr.: 2012-02}
%---------------------------------------------------------------------------
\opening{}
...
\hline\\
CON-016-2012 & February 2012 & Web Site Implementation & 150 EUR\\
\hline\\
\end{tabular}
\vfil
\begin{flushright}
