...
%---------------------------------------------------------------------------
\begin{letter}{ {\bf \textcolor[HTML]{64B400}{Ableton}}\\
{\bf Software Engineering team}}
%---------------------------------------------------------------------------
\setkomavar{subject}{\bf Trainee Software Engineer}
%---------------------------------------------------------------------------
\opening{Dear SE Team}
I was very happy to know that Ableton is open to unconventional-career-path applications
and that the Developers Team offer a coaching program.

Fresh of my doctorate in mathematics, I'd like to re-invest my logical background
to learn and work with complex object oriented programming.
Via synctactic analyse, comprehend and extend a complex system..

I strongly believe, an intensive {\em hands-on} training will
fill-up in a short period my missing 

I have a primary understanding of the core concepts behind object orientation
and a knowledge of the syntactical 
and interested in more advanced features,
like template oriented developement \dots basic syntax of low-level languages like $C^{++}$ or Objective-$C$.

\medskip
I am not scared to start in a pre-Junior position, and am eager to face
new and complex problems, for -- as my experience with programming so far shows --
only with solving practical tasks I can extend my skills of a language.

I am looking forward to receiving any feed-back, along with
the first programming tasks mentioned in the call.
